...
class PlacefieldSnapshot(object):
    ...
    def to_dict(self):
        return {
            ...
            'raw_smoothed_occupancy_map': copy_if_not_none(self.num_position_samples_smoothed_occupancy),
    ...
    @classmethod
    def from_dict(cls, d):
        # builds from a dict with keys: ['spikes_maps_matrix', 'smoothed_spikes_maps_matrix', 'raw_occupancy_map', 'raw_smoothed_occupancy_map', 'seconds_occupancy', 'normalized_occupancy', 'occupancy_weighted_tuning_maps_matrix']
        return cls(
            num_position_samples_occupancy=d["raw_occupancy_map"],
            num_position_samples_smoothed_occupancy=d["raw_smoothed_occupancy_map"],
