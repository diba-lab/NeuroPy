...
def correlation_emg(signal: core.Signal, probe: core.ProbeGroup, window, overlap, n_jobs=...):
    """Calculating emg
...
def detect_brainstates_epochs(signal: core.Signal, probe: core.ProbeGroup, window=..., overlap=..., emg: core.Signal = ..., sigma=..., ignore_epochs=...):
