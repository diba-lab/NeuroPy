...
This type stub file was generated by pyright.
"""
def radon_transform(arr, nlines=..., dt=..., dx=..., neighbours=...):
...
def old_radon_transform(arr, nlines=...):
...
def epochs_spkcount(neurons: Union[core.Neurons, pd.DataFrame], epochs: Union[core.Epoch, pd.DataFrame], bin_size=..., slideby=..., export_time_bins: bool = ..., included_neuron_ids=..., debug_print: bool = ..., use_single_time_bin_per_epoch: bool = ...):
...
class Decode1d:
    ...
    def calculate_shuffle_score(self, n_iter=..., method=...):
    ...
    def plot_replay_epochs(self, pval=..., speed_thresh=..., cmap=...):
        ...
...
class Decode2d:
    ...
    def estimate_behavior(self, spikes_df, t_start_end, time_bin_size=..., smooth=..., plot=...):
        """ 
        Updates:
    ...
    def decode_events(self, binsize=..., slideby=...):
