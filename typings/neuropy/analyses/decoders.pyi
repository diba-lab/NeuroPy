...
def radon_transform(arr: NDArray, nlines: int = ..., dt: float = ..., dx: float = ..., n_neighbours: int = ..., enable_return_neighbors_arr=...): # -> tuple[Any, Any, Any, tuple[int, NDArray[Any], RadonTransformDebugValue]] | tuple[Any, Any, Any]:
