...
def corr_across_time_window(neurons: core.Neurons, window=..., bin_size=...):
...
def corr_pairwise(neurons: core.Neurons, ids, period, cross_shanks=..., binsize=..., window=..., slideby=...): # -> tuple[Any, Any | None]:
