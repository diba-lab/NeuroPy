...
class Epoch(HDFMixin, StartStopTimesMixin, TimeSlicableObjectProtocol, DataFrameRepresentable, DataFrameInitializable, DataWriter):
    ...
    def fill_blank(self, method=...):
        ...
    
    def delete_in_between(self, t1, t2):
        ...
    
    def get_proportion_by_label(self, t_start=..., t_stop=...):
        ...
    
    def count(self, t_start=..., t_stop=..., binsize=...):
        ...
    
    def to_neuroscope(self, ext=...):
    ...
    @classmethod
    def from_PortionInterval(cls, portion_interval, metadata=...):
        ...
    
    def to_PortionInterval(self):
        ...
    
    def get_non_overlapping(self, debug_print=...):
