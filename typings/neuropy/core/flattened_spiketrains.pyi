...
class SpikesAccessor(TimeSlicedMixin):
    ...
    def get_split_by_unit(self, included_neuron_ids=...):
    ...
    def interpolate_spike_positions(self, position_sampled_times, position_x, position_y, position_linear_pos=..., position_speeds=...):
        ...
    ...
    def rebuild_fragile_linear_neuron_IDXs(self, debug_print=...):
    ...
    def add_binned_time_column(self, time_window_edges, time_window_edges_binning_info: BinningInfo, debug_print: bool = ...):
        """ adds a 'binned_time' column to spikes_df given the time_window_edges and time_window_edges_binning_info provided 
        
        """
        ...
    
    def adding_lap_identity_column(self, laps_epoch_df, epoch_id_key_name: str = ...):
    ...
    def adding_epochs_identity_column(self, epochs_df: pd.DataFrame, epoch_id_key_name: str = ..., epoch_label_column_name=..., override_time_variable_name=..., no_interval_fill_value=...):
