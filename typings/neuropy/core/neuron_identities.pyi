...
class NeuronIdentity(SimplePrintable):
    ...
    @classmethod
    def init_from_NeuronExtendedIdentityTuple(cls, a_tuple: NeuronExtendedIdentityTuple, a_color=...):
...
class NeuronIdentityAccessingMixin:
    ...
    def get_neuron_id_and_idx(self, neuron_i=..., neuron_id=...):
...
class NeuronIdentitiesDisplayerMixin:
    ...
    def get_extended_neuron_id_string(self, neuron_i=..., neuron_id=...):
        ...
