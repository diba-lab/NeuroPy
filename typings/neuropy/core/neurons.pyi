...
class Neurons(HDF_SerializationMixin, NeuronUnitSlicableObjectProtocol, StartStopTimesMixin, TimeSlicableObjectProtocol, ConcatenationInitializable, DataWriter):
    ...
    def get_binned_spiketrains(self, bin_size=...):
    ...
    @classmethod
    def initialize_missing_spikes_df_columns(cls, spikes_df, debug_print=...):
        """ make sure the needed columns exist on spikes_df """
        ...
    
    @classmethod
    def from_dataframe(cls, spikes_df, dat_sampling_rate, time_variable_name=...):
...
class BinnedSpiketrain(NeuronUnitSlicableObjectProtocol, DataWriter):
    ...
    @staticmethod
    def from_neurons(neurons: Neurons, t_start=..., t_stop=..., bin_size=...):
        ...
...
class Mua(DataWriter):
    ...
    def get_smoothed(self, sigma=..., truncate=...):
        ...
