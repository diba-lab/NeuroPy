...
class Fig:
    labelsize = ...
    def draw(self, num=..., grid=..., size=..., style=..., **kwargs):
        ...
    
    def add_subplot(self, subplot_spec):
        ...
    
    def subplot2grid(self, subplot_spec, grid=..., **kwargs):
    ...
    def panel_label(self, ax, label, fontsize=...):
        ...
    
    def savefig(self, fname: Path, scriptname=..., fig=...):
        ...
    ...
    @staticmethod
    def set_spines_width(ax, lw=..., sides=...):
        ...
    
    @classmethod
    def get_mpl_style(cls, style: str = ...):
...
def make_boxes(ax, xdata, ydata, xerror, yerror, facecolor=..., edgecolor=..., alpha=...):
    ...
