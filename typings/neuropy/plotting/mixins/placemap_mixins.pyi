...
class PfnD_PlotOccupancy_Mixin:
    ...
    def plot_occupancy(self, identifier_details_list=..., fig=..., ax=..., active_context=..., **kwargs):
...
class PfnDPlottingMixin(PfnD_PlotOccupancy_Mixin):
    def plot_ratemaps_1D(self, ax=..., pad=..., normalize=..., sortby=..., cmap=..., active_context=..., **kwargs):
