...
def plot_ratemap_2D(ratemap: Ratemap, computation_config=..., included_unit_indicies=..., included_unit_neuron_IDs=..., subplots: RowColTuple = ..., fig_column_width: float = ..., fig_row_height: float = ..., resolution_multiplier: float = ..., max_screen_figure_size=..., fignum=..., fig=..., enable_spike_overlay=..., spike_overlay_spikes=..., extended_overlay_points_datasource_dicts=..., drop_below_threshold: float = ..., brev_mode: PlotStringBrevityModeEnum = ..., plot_variable: enumTuningMap2DPlotVariables = ..., plot_mode: enumTuningMap2DPlotMode = ..., bg_rendering_mode=..., use_special_overlayed_title=..., missing_aclu_string_formatter=..., debug_print=...):
...
@safely_accepts_kwargs
def plot_ratemap_1D(ratemap: Ratemap, normalize_xbin=..., fignum=..., fig=..., ax=..., pad=..., normalize_tuning_curve=..., sortby=..., cmap=..., included_unit_indicies=..., included_unit_neuron_IDs=..., brev_mode: PlotStringBrevityModeEnum = ..., plot_variable: enumTuningMap2DPlotVariables = ..., curve_hatch_style=..., missing_aclu_string_formatter=..., single_cell_pfmap_processing_fn=..., active_context=..., use_flexitext_titles=..., use_flexitext_ticks=..., ytick_location_shift: float = ..., plot_zero_baselines: bool = ..., skip_figure_titles: bool = ..., flat_stack_mode: bool = ..., debug_print=...):
...
@safely_accepts_kwargs
def plot_raw(ratemap: Ratemap, t, x, run_dir, ax=..., subplots=...):
