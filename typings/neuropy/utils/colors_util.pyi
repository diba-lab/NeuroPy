...
class ColorsUtil:
    ...
    colors = ...
    @staticmethod
    def compute_needed_single_hue_variations(n_needed_colors, colors): # -> tuple[Any, int]:
    ...
    @staticmethod
    def pho_categorical_colormap(n_needed_colors, colors: np.array, debug_print=...):
    ...
    @staticmethod
    def categorical_cmap(nc, nsc, cmap=..., continuous=...):
