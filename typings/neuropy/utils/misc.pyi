...
def shuffle_ids(neuron_ids, seed: Optional[int] = ...):
...
def safe_item(arr: np.ndarray, *args, default=...):
...
def convert_dataframe_columns_to_datatype_if_possible(df: pd.DataFrame, datatype_str_column_names_list_dict, debug_print=...):
...
def add_explicit_dataframe_columns_from_lookup_df(df, lookup_properties_map_df, join_column_name=...):
