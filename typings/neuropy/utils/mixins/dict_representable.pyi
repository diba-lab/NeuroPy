...
class SubsettableDictRepresentable(DictRepresentable):
    ...
    def keys(self, subset_includelist=..., subset_excludelist=...):
        ...
    
    def keypaths(self, subset_includelist=..., subset_excludelist=...):
        ...
    
    def as_tuple(self, subset_includelist=..., subset_excludelist=..., drop_missing: bool = ...):
