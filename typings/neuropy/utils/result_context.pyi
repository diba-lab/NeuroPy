...
class DisplaySpecifyingIdentifyingContext(IdentifyingContext):
    ...
    display_dict: Dict = ...
    @classmethod
    def init_from_context(cls, a_context: IdentifyingContext, display_dict=...) -> DisplaySpecifyingIdentifyingContext:
        ...
    
    def get_specific_purpose_description(self, specific_purpose: str, subset_includelist=..., subset_excludelist=...) -> Optional[str]:
        """ returns a simple text descriptor of the context
